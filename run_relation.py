...
def convert_examples_to_features(examples, label2id, max_seq_length, tokenizer, special_tokens, unused_tokens=True):
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        print(example["token"], sub_idx, example["subj_start"], example["obj_start"])
        tokens.append(SEP)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--task', type=str, default=None, required=True, choices=['ace04', 'ace05', 'scierc', 'mars'])
